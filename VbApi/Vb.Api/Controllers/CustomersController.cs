...
public class CustomersController : ControllerBase
{
    ...
    public async Task<ApiResponse<List<CustomerResponse>>> GetCustomerByParameterQuery(string FirstName,string LastName,string IdentiyNumber)
    {
        var operation = new  GetCustomerByParameterQuery(FirstName,LastName,IdentiyNumber);
        var result = await mediator.Send(operation);
        return result;
    }
