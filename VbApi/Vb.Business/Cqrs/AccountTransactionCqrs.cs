...
public record GetAccountTransactionByParameterQuery(DateTime TransactionDate,string TransferType,string Description) : IRequest<ApiResponse<List<AccountTransactionResponse>>>;