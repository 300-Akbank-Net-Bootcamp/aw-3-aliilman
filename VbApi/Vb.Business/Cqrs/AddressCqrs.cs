...
public record GetAddressByParameterQuery(string Address1,string Address2,string Country,string City,string County, string PostalCode) : IRequest<ApiResponse<List<AddressResponse>>>;
